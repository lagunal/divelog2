...
class DiveSessions extends Table {
  ...
  TextColumn get operatorAddress =>
      text().nullable()(); // Direccion de la Operadora
  TextColumn get diveType => text()
      .nullable()(); // Tipo de Buceo (Scuba, Asist. Superficie, Altura Geografica, Saturacion)
  TextColumn get diversNames =>
      text().nullable()(); // Nombre de Buzos (Replaces 'buddy')
  ...
  IntColumn get surfaceInterval =>
      integer().nullable()(); // Tiempo de intervalo en superficie (minutes)
  IntColumn get bottomTime => integer()(); // Tiempo de fondo (minutes)
  DateTimeColumn get decompressionStart =>
      dateTime().nullable()(); // Inicio de descompresion
  DateTimeColumn get decompressionComplete =>
      dateTime().nullable()(); // Descompresion completa
  IntColumn get totalDiveTime =>
      integer().nullable()(); // Tiempo Total de inmersion (minutes)

  // --- Technical & Work (Técnico y Trabajo) ---
  TextColumn get gasMixture => text().nullable()(); // Mezcla Utilizada
  TextColumn get workDescription =>
      text().nullable()(); // Descripcion de trabajo (Replaces 'notes')
  TextColumn get decompressionUsed =>
      text().nullable()(); // Descompresion utilizada
  ...
  IntColumn get accumulatedSupervisionTime =>
      integer().nullable()(); // Tiempo de supervision acumulado
  IntColumn get accumulatedDiveTime =>
      integer().nullable()(); // Tiempo de Buceo Acumulado
